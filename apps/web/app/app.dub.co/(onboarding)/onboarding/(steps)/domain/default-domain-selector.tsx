    ...
    <>
      <div className="animate-fade-in mx-auto grid w-full max-w-[312px] gap-4 sm:max-w-[600px] sm:grid-cols-2">
        ...
        <DomainOption
          ...
          title={
            <>{t.rich('options.free-link-domain.title', {
          ...
          description={
            <>{t.rich('options.free-link-domain.description', {
              workspaceSlug: workspaceSlug && workspaceSlug.length < 8 ? workspaceSlug : "company",
