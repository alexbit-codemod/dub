    ...
    >
      ...
      <div>
        ...
        <div className="relative mt-2 flex rounded-md shadow-sm">
          <span className="inline-flex items-center rounded-l-md border border-r-0 border-neutral-300 bg-neutral-50 px-5 text-neutral-500 sm:text-sm">{t('prefixes.workspace-slug-domain', { "processEnvNextPublicAppDomain": process.env.NEXT_PUBLIC_APP_DOMAIN })}
          </span>
          <input
            id="slug"
            type="text"
